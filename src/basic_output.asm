; basic output using only real mode BIOS interrupts

; ds:si = strptr
print_str:
	pusha 
	mov ah, 0xe 	; video interrupt teletype mode
.read_char:
	lodsb		; load next string byte into al
	cmp al, 0
	jne .print_char
	popa
	ret
.print_char:
	int 0x10	; video interrupt, print char
	jmp .read_char
...
print_hex:
	...
	and cx, 00001111b
	call convert_char
	mov si, HEX_OUT   ; Point si register at start address of string.
	call print_str    ; Print HEX_OUT.
	popa
	ret
